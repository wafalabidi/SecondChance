...
public class SignUpFragment extends AuthFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        confirm_password_edit = (EditText)view.findViewById(R.id.confirm_password_edit);
    ...
    public void onClick(View v) {
        ...
        if ((!TextUtils.isEmpty(email_input_edit.getText().toString()))
                && (!TextUtils.isEmpty(password_input_edit.getText()))
                && (!TextUtils.isEmpty(confirm_password_edit.getText()))
            ...
            call.enqueue(new retrofit2.Callback<ConfirmationResponse>() {
                @Override

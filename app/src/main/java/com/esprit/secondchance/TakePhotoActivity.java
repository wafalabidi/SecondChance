...
import com.esprit.secondchance.view.RevealBackgroundView;
...
public class TakePhotoActivity extends BaseActivity implements RevealBackgroundView.OnStateChangeListener,
    ...
    @BindView(R.id.openGqllery)
    ImageButton openGqllery;
    static Boolean isUsingFrontCamera = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openGqllery.setOnClickListener(v -> {
            openGallery();
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_PHOTO && data != null) {
            ...
            String string = getRealPathFromURI_API19(this,path) ;

            FilterActivity.openWithPhotoUri(this,Uri.parse(string));
        }
    }
    @SuppressLint("NewApi")
